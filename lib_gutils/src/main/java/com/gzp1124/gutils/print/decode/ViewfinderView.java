...
public final class ViewfinderView extends RelativeLayout {
  ...
  public void setInit(CameraManager cameraManager, int moveY, CaptureActivity activity) {
  ...
  public void onDraw(Canvas canvas) {
    ...
    Rect frame = activity.getCropRect();
    if (frame == null) {
      return;
    }
  ...
  public synchronized Rect getFramingRectInPreview() {
    if (framingRectInPreview == null) {
      Rect framingRect = activity.getCropRect();
      if (framingRect == null) {
        return null;
      }
