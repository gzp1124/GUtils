...
class HVSlidingTabStrip extends LinearLayout {
    ...
    HVSlidingTabStrip(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    void setCustomTabColorizer(HVSlidingTabLayout.TabColorizer customTabColorizer) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final HVSlidingTabLayout.TabColorizer tabColorizer =
    ...
    private static class SimpleTabColorizer implements HVSlidingTabLayout.TabColorizer {
