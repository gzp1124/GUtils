...
public class GDialogUtil {
    ...
    public static AlertDialog.Builder getMessageDialog(Context context, String message, String okBtn, DialogInterface.OnClickListener onClickListener) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setMessage(message);
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context, String message, String okBtnText, DialogInterface.OnClickListener onClickListener) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setMessage(Html.fromHtml(message));
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context, String message, String okBtnText, String errorBtnText, DialogInterface.OnClickListener onClickListener) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setMessage(Html.fromHtml(message));
        builder.setPositiveButton(okBtnText, onClickListener);
        builder.setNegativeButton(errorBtnText, null);
        return builder;
    }
